...
[`@aws-sdk/client-iotthingsgraph`](https://www.npmjs.com/package/@aws-sdk/client-iotthingsgraph/v/3.515.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-iotthingsgraph@3.515.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LVaD9DC9GStOoDbOfCexv29OUtxP818bVWCOHwaAoIZYb2WX/FwhY5iftT6sv1V+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-iotthingsgraph": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-iotthingsgraph@3.515.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-iotthingsgraph@3.515.0/index.min.mjs": "sha384-LVaD9DC9GStOoDbOfCexv29OUtxP818bVWCOHwaAoIZYb2WX/FwhY5iftT6sv1V+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-iotthingsgraph/blob/refs/tags/3.515.0/LICENSE
```
