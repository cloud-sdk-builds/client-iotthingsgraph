...
[`@aws-sdk/client-iotthingsgraph`](https://www.npmjs.com/package/@aws-sdk/client-iotthingsgraph/v/3.408.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-iotthingsgraph@3.408.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rHWmvHythWSvmHEeCn+rJNoqn82gP8sokdkEI6qUJXJ04zEvtMCHJtSQwhMYW6QB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-iotthingsgraph": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-iotthingsgraph@3.408.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-iotthingsgraph@3.408.0/index.min.mjs": "sha384-rHWmvHythWSvmHEeCn+rJNoqn82gP8sokdkEI6qUJXJ04zEvtMCHJtSQwhMYW6QB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-iotthingsgraph/blob/refs/tags/3.408.0/LICENSE
```
